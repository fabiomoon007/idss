...
Periodicity } from '../types.js';
import { getPeriodLabels, CURRENT_YEAR as APP_CURRENT_YEAR } from '../constants.js'; // Using APP_CURRENT_YEAR to avoid conflict
...
const HistoricalDataManagementPage = ({ onClose, initialIndicators, allDimensions, currentHistoricalData, onHistoricalDataUpdated }) => {
    ...
    return (_jsxs("div", { className: "p-4 sm:p-6 bg-white shadow-xl rounded-xl", children: [_jsxs("div", { className: "flex justify-between items-center mb-6", children: [_jsx("h2", { className: "text-2xl font-bold text-[#004e4c]", children: "Gerenciar Dados Hist\u00F3ricos Fixos" }), _jsxs("button", { onClick: onClose, className: "bg-[#00995d] hover:bg-[#007a4a] text-white font-semibold py-2 px-3 rounded-md shadow-sm transition duration-150 flex items-center text-sm", children: [_jsx(ArrowLeft, { size: 16, className: "mr-1.5" }), " Voltar ao Painel"] })] }), _jsx("div", { className: "mb-6 p-4 bg-blue-50 border-l-4 border-blue-400 text-blue-700 rounded-r-lg", children: _jsxs("div", { className: "flex items-start", children: [_jsx(Info, { size: 20, className: "mr-3 mt-0.5 flex-shrink-0" }), _jsxs("div", { children: [_jsx("h4", { className: "font-bold", children: "Como Funciona esta P\u00E1gina" }), _jsxs("p", { className: "text-sm", children: ["Esta se\u00E7\u00E3o permite editar os dados hist\u00F3ricos fixos. Como a aplica\u00E7\u00E3o n\u00E3o possui um banco de dados, as altera\u00E7\u00F5es ", _jsx("strong", { children: "n\u00E3o s\u00E3o salvas no servidor" }), ". Em vez disso, ao clicar no bot\u00E3o \"Baixar Arquivo JSON\", um novo arquivo ", _jsx("code", { children: "historical_data.json" }), " ser\u00E1 gerado e baixado para o seu computador. Para que as altera\u00E7\u00F5es tenham efeito permanente na aplica\u00E7\u00E3o, voc\u00EA precisar\u00E1 substituir o arquivo existente no projeto por este novo e fazer o deploy novamente."] })] })] }) }), _jsxs("div", { className: "mb-6", children: [_jsx("label", { htmlFor: "historical-year-select", className: "block text-sm font-medium text-gray-700 mb-1", children: "Selecione o Ano Base para Gerenciamento:" }), _jsx("select", { id: "historical-year-select", value: selectedYear, onChange: (e) => {
                            setStatus(null);
                            setSelectedYear(parseInt(e.target.value));
                        }, className: "mt-1 block w-full sm:w-1/3 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-[#00995d] focus:border-[#00995d] sm:text-sm rounded-md shadow-sm", children: yearsOptions.map(year => (_jsx("option", { value: year, children: year }, year))) })] }), _jsxs("div", { className: "space-y-8", children: [_jsxs("section", { className: "p-4 border border-gray-200 rounded-lg shadow-sm", children: [_jsxs("h3", { className: "text-lg font-semibold text-[#004e4c] mb-3", children: ["IDSS Global (", selectedYear, ")"] }), _jsxs("div", { children: [_jsxs("label", { htmlFor: `idss-global-score-${selectedYear}`, className: "block text-sm font-medium text-gray-700", children: ["Nota Final IDSS (Programa ", selectedYear + 1, ", Base ", selectedYear, "):"] }), _jsx("input", { type: "text", id: `idss-global-score-${selectedYear}`, value: currentIdssScoreEntry?.score === null || currentIdssScoreEntry?.score === undefined ? '' : String(currentIdssScoreEntry.score), onChange: handleIdssScoreChange, placeholder: "Ex: 0.7787", className: "mt-1 block w-full sm:w-1/2 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#00995d] focus:border-[#00995d] sm:text-sm" })] })] }), _jsxs("section", { className: "p-4 border border-gray-200 rounded-lg shadow-sm", children: [_jsxs("h3", { className: "text-lg font-semibold text-[#004e4c] mb-3", children: ["Notas Finais das Dimens\u00F5es (", selectedYear, ")"] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: allDimensions.map(dim => (_jsxs("div", { children: [_jsxs("label", { htmlFor: `dim-score-${dim.id}-${selectedYear}`, className: "block text-sm font-medium text-gray-700", children: [dim.name, " (", dim.id, "):"] }), _jsx("input", { type: "text", id: `dim-score-${dim.id}-${selectedYear}`, value: currentDimensionScoresEntry?.dimensionScores[dim.id] === null || currentDimensionScoresEntry?.dimensionScores[dim.id] === undefined ? '' : String(currentDimensionScoresEntry?.dimensionScores[dim.id]), onChange: (e) => handleDimensionScoreChange(dim.id, e), placeholder: "Ex: 0.850", className: "mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-[#00995d] focus:border-[#00995d] sm:text-sm" })] }, dim.id))) })] }), _jsxs("section", { className: "p-4 border border-gray-200 rounded-lg shadow-sm", children: [_jsxs("h3", { className: "text-lg font-semibold text-[#004e4c] mb-3", children: ["Dados dos Indicadores (", selectedYear, ")"] }), _jsx("div", { className: "space-y-6", children: initialIndicators.map(indicator => {
                                    ...
                                    return (_jsxs("div", { className: "p-3 border border-gray-100 rounded-md bg-gray-50", children: [_jsxs("h4", { className: "text-md font-medium text-gray-800 mb-2", children: [indicator.id, " - ", indicator.name] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-600", children: "Nota Final" }), _jsx("input", { type: "text", placeholder: "Ex: 0.950", value: yearEntry?.notaFinal === null || yearEntry?.notaFinal === undefined ? '' : String(yearEntry.notaFinal), onChange: e => handleIndicatorFieldChange(indicator.id, 'notaFinal', parseNumericInput(e.target.value)), className: "mt-0.5 w-full text-xs p-1.5 border-gray-300 rounded-md shadow-sm" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-600", children: "Resultado Consolidado" }), _jsx("input", { type: "text", placeholder: indicator.valueLabel || "Valor", value: yearEntry?.consolidatedValue === null || yearEntry?.consolidatedValue === undefined ? '' : String(yearEntry.consolidatedValue), onChange: e => handleIndicatorFieldChange(indicator.id, 'consolidatedValue', parseNumericInput(e.target.value)), className: "mt-0.5 w-full text-xs p-1.5 border-gray-300 rounded-md shadow-sm" })] }), indicator.requiresAuxValue && (_jsxs("div", { children: [_jsx("label", { className: "block text-xs font-medium text-gray-600", children: indicator.auxValueLabel || "Valor Aux. Consolidado" }), _jsx("input", { type: "text", placeholder: indicator.auxValueLabel || "Valor Aux.", value: yearEntry?.consolidatedAuxValue === null || yearEntry?.consolidatedAuxValue === undefined ? '' : String(yearEntry.consolidatedAuxValue), onChange: e => handleIndicatorFieldChange(indicator.id, 'consolidatedAuxValue', parseNumericInput(e.target.value)), className: "mt-0.5 w-full text-xs p-1.5 border-gray-300 rounded-md shadow-sm" })] })), _jsxs("div", { className: "md:col-span-2 lg:col-span-1", children: [_jsxs("label", { className: "block text-xs font-medium text-gray-600", children: ["Periodicidade Usada em ", selectedYear] }), _jsxs("select", { value: yearEntry?.periodicityUsed ?? '', onChange: e => handleIndicatorFieldChange(indicator.id, 'periodicityUsed', e.target.value === "" ? null : e.target.value), className: "mt-0.5 w-full text-xs p-1.5 border-gray-300 rounded-md shadow-sm", children: [_jsx("option", { value: "", children: "N\u00E3o Registrar Periodicidade" }), Object.values(Periodicity).map(p => _jsx("option", { value: p, children: p }, p))] })] })] }), (yearEntry?.periodicityUsed && yearEntry.periodicData && yearEntry.periodicData.length > 0) && (_jsxs("div", { className: "mt-3 pt-3 border-t border-gray-200", children: [_jsxs("h5", { className: "text-sm font-medium text-gray-700 mb-1.5", children: ["Dados Peri\u00F3dicos (", yearEntry.periodicityUsed, ", ", selectedYear, ")"] }), _jsx("div", { className: `grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-${indicator.requiresAuxValue ? 3 : 4} gap-x-3 gap-y-2`, children: yearEntry.periodicData.map((pd, pIdx) => (_jsxs("div", { className: `flex flex-col space-y-1 ${indicator.requiresAuxValue ? '' : 'sm:col-span-1'}`, children: [_jsxs("span", { className: "text-xs text-gray-500 self-center", children: [pd.periodLabel, ":"] }), _jsxs("div", { className: "flex space-x-1", children: [_jsx("input", { type: "text", placeholder: "Valor", value: pd.value === null || pd.value === undefined ? '' : String(pd.value), onChange: (e) => handlePeriodicDataChange(indicator.id, pIdx, 'value', e), className: "w-full text-xs p-1 border-gray-300 rounded-md shadow-sm" }), indicator.requiresAuxValue && (_jsx("input", { type: "text", placeholder: "Aux.", value: pd.auxValue === null || pd.auxValue === undefined ? '' : String(pd.auxValue), onChange: (e) => handlePeriodicDataChange(indicator.id, pIdx, 'auxValue', e), className: "w-full text-xs p-1 border-gray-300 rounded-md shadow-sm" }))] })] }, pd.periodLabel))) })] }))] }, indicator.id));
                                }) })] }), _jsxs("div", { className: "mt-8 flex flex-col items-center", children: [_jsxs("button", { onClick: handleDownload, disabled: isProcessing, className: "w-full sm:w-auto bg-[#1e3a8a] hover:bg-[#1c3276] text-white font-semibold py-2.5 px-6 rounded-md shadow-md transition duration-150 ease-in-out disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center", children: [_jsx(Download, { size: 18, className: "mr-2" }), isProcessing ? 'Gerando...' : `Baixar Arquivo JSON Histórico`] }), status && (_jsxs("div", { className: `mt-3 p-2.5 rounded-md text-sm flex items-center ${status.type === 'success' ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-700'}`, children: [status.type === 'success' ? _jsx(CheckCircle, { size: 18, className: "mr-2" }) : _jsx(AlertTriangle, { size: 18, className: "mr-2" }), status.message] }))] })] })] }));
};
